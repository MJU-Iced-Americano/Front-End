    ...
    const OperatorCoOpModifyContent =()=>{
        ...
        return (
            <div className="CoOpManage">
                ...
                <div>
                    <input placeholder="CoOp index를 적으시오" onChange={onChangeIndex} value={companyIndex} className="inputStyle" type='number'/>
                    <input placeholder="CoOp Name를 적으시오" onChange={onChangeName} value={companyName} className="inputStyle" type='text'/>
                    <input placeholder="CoOp url을 적으시오" onChange={onChangeURL} value={companyURL} className="inputStyle" type='text'/>
                </div>
                <div>
                    <button onClick={()=> {setDoEnroll(!doEnroll);}}>수정하기</button>
